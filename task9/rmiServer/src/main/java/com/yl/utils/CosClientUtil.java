...
public class CosClientUtil {
    ...
    public CosClientUtil(String secretId, String secretKey, String address, String bucketName) {
    ...
    public COSClient cosClient(){
        ...
        ClientConfig clientConfig = new ClientConfig(new Region(address));
        // 3 生成cos客户端
    ...
    public void cosDownLoadFile(String key,File downloadFile) {
//        // 1 初始化用户身份信息(secretId, secretKey)
