    ...
    public Boolean add(List<Student> list) {
        ...
        this.getJdbcTemplate().batchUpdate(sql, new BatchPreparedStatementSetter() {
            ...
            public void setValues(PreparedStatement ps, int i) throws SQLException {
                ...
                ps.setInt(2, studentList.get(i).getNumber());
                ps.setInt(3, studentList.get(i).getQq());
                ps.setString(4, studentList.get(i).getSubject());
                ps.setLong(5, studentList.get(i).getJoinTime());
                ps.setString(6, studentList.get(i).getSchool());
                ps.setString(7, studentList.get(i).getWish());
                ps.setString(8, studentList.get(i).getInstructor());
                ps.setString(9, studentList.get(i).getKnowFrom());
                ps.setLong(10, studentList.get(i).getCreateAt());
                ps.setLong(11, studentList.get(i).getUpdateAt());
            }
