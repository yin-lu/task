...
<div  style="display: flex; justify-content:space-around;align-content: center;width: 100%">
    <div style=" margin-top: 300px;">
        ...
        <table>
            <h2> <a href="/email">点击进入邮箱注册页面</a></h2>
            ...
            <tr>
                <td>手机号:</td>
                <td><input class="easyui-validatebox" required="true" missingMessage="手机号必须填写" size="20"  type="text" name="phone" id="phone" value=""></td>
            </tr>
            <tr>
                <td>验证码:</td>
                <td><input class="easyui-validatebox" required="true" missingMessage="验证码必须填写" size="20"  type="text" name="msgCode"></td>
