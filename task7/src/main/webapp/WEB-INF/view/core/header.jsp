            ...
            <div class="head-box">
                <span class="text-success">
                    ...
                    String image= (String) request.getSession().getAttribute("image");
                       if (user==null){%>
                    <a href="/login" >登录</a>丨<a href="/phone">注册</a></span>
                <%}else{ %>
                欢迎 ${user.name}|<a href="/u/details/${user.id}">
                <% if(image!=null){%>
                <img src="${image}" width="30",height="30">
                <%}else {%>
                <img src="${user.image}" width="30",height="30">
                <%}%>
                </a> |<a href="/outLogin">退出</a> </span>
                <%}%>
                ...
                <%--<c:if test="${user==null}">--%>
                    <%--<a href="/login" >登录</a>丨<a href="/phone">注册</a></span></c:if>--%>
                <%--<c:if test="${user!=null}">--%>
